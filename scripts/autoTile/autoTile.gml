function autoTile() {
	...
	iw          = sprite_width;
	w_left      = place_meeting(x-iw,y,oParSolid);
	w_right     = place_meeting(x+iw,y,oParSolid);
	w_up        = place_meeting(x,y-iw,oParSolid);
	w_down      = place_meeting(x,y+iw,oParSolid);
	w_upleft    = place_meeting(x-iw,y-iw,oParSolid);
	w_downleft  = place_meeting(x-iw,y+iw,oParSolid);
	w_upright   = place_meeting(x+iw,y-iw,oParSolid);
	w_downright = place_meeting(x+iw,y+iw,oParSolid);
