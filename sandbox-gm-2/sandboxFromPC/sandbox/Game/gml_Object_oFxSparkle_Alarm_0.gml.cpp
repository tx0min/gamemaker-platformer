...
extern YYVAR g_Script_gml_Object_oFxSparkle_Alarm_0;
#ifndef __YYNODEFS
#else
#endif // __YYNODEFS

void gml_Object_oFxSparkle_Alarm_0( CInstance* pSelf, CInstance* pOther );
#ifndef __YYNODEFS
void gml_Object_oFxSparkle_Alarm_0( CInstance* pSelf, CInstance* pOther )
{
YY_STACKTRACE_FUNC_ENTRY( "gml_Object_oFxSparkle_Alarm_0", 0 );
...
YYRValue* sWself_hsp = &((CInstanceBase*)pSelf)->GetYYVarRefL(kVARID_self_hsp); /* set ContextID to 89 */
...
YYRValue* sWself_vsp = &((CInstanceBase*)pSelf)->GetYYVarRefL(kVARID_self_vsp); /* set ContextID to 89 */
...
YYRValue* sWself_rotsp = &((CInstanceBase*)pSelf)->GetYYVarRefL(kVARID_self_rotsp); /* set ContextID to 89 */
